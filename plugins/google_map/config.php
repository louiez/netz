...
$api_key=$Config->get('api_key', 'plugin_info');
...
<?php 
	...
	if ($save == "save"){
		...
		$Config->set('api_key',$mydata, 'plugin_info');
...
echo "Google Map API Key<input type=\"text\" name=\"submitted_data\" id=\"submitted_data\" value=".$api_key."><br>";
echo "<input class=\"button\" type=\"submit\" name=\"mysubmit\" id=\"mysubmit\"><br>";
echo "</form>";
}
?>
